...
function wle_register_classes( $wp_customize ) {
  if ( class_exists( 'WP_Customize_Control' ) ) { 
	...
	else: echo __( 'Please' , 'widget-live-editor' ) . "<a href='media-new.php'>" . __( 'upload images' , 'widget-live-editor' ) . "</a>";	  
	endif; 
      }
    }
	...
	<?php    
	$page_uri_query = new WP_Query( array( 'post_type' => 'page' , 'posts_per_page' => -1 ) ); 
