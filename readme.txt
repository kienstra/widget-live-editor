...
1. From the front of your site, find a page that has widgets.
1. If you have the plugin "Adapter Widget Rows," click the "plus" icon, and select "Live Editor."
1. If you don't have "Adapter Widget Rows," click "Customize" in the top admin bar.
1. Click "Widgets" > "Add a Widget."
1. Select a "Live Editor" widget.
1. Find the editing section in the "Live Editor Widgets" panel, above the "Widgets" panel.
...
1. Edit as you see your full page. Your site won't update until you click "Save & Publish."
2. Choose from any of your images, or no image.
3. Re-size the image.
4. Include a link to any page or post.
5. See the text on your page as you type.
